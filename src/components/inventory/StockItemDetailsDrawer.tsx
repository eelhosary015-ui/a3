          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1 flex items-center gap-3">
                <span>التصنيف: <strong className="text-slate-200">{item?.category || "عام"}</strong></span>
                {item?.brand && <span>الماركة: <strong className="text-slate-200">{item.brand}</strong></span>}
                {item?.barcode && <span>الباركود: <strong className="font-mono text-slate-200">{item.barcode}</strong></span>}
              </p>
            </div>
          </div>
          <div className="flex items-center gap-2">
