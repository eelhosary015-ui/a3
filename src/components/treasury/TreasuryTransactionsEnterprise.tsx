...
// Fallback Mock Transactions to ensure page NEVER renders blank if API is offline or empty
const MOCK_TRANSACTIONS: TreasuryTransaction[] = [
  {
    ...
    voucher_number: "REC-2026-0891",
    voucher_type: "receipt",
    payment_method: "cash",
    client_type: "customer",
    client_name: "شركة الأمل للتوريدات العمومية",
    notes: "تحصيل دفعة نقدية تحت حساب الفاتورة رقم #INV-4022",
    balance_before: 125000,
    balance_after: 140000,
    status: "approved",
    created_by: 1,
    user_name: "أحمد المحاسب",
    account_name: "الخزينة الرئيسية - السويس",
  ...
  },
  {
    ...
    voucher_number: "PAY-2026-0412",
    voucher_type: "payment",
    payment_method: "cash",
    client_type: "supplier",
    client_name: "مصنع الشرق للكرتون والتغليف",
    notes: "سداد قيمة خامات ومستلزمات تعبئة خفيفة",
    balance_before: 140000,
  ...
  },
  {
    ...
    amount: -1200,
    transaction_type: "cash_out",
    voucher_number: "PAY-2026-0413",
    voucher_type: "payment",
    payment_method: "cash",
    client_type: "employee",
    client_name: "محمود حسن (فني صيانة)",
    notes: "صرف سلفة مؤقتة لأعمال الصيانة الدورية للأجهزة",
    balance_before: 136500,
    balance_after: 135300,
    status: "approved",
    created_by: 1,
    user_name: "أحمد المحاسب",
    account_name: "الخزينة الرئيسية - السويس",
  ...
  },
  {
    ...
    voucher_number: "TRF-2026-0105",
    voucher_type: "receipt",
    payment_method: "bank",
    client_type: "other",
    client_name: "تحويل بين الخزائن",
    notes: "تغذية خزينة الفرع من البنك الأهلي المصري",
    balance_before: 20000,
    balance_after: 70000,
    status: "approved",
    created_by: 1,
    user_name: "المدير المالي",
    account_name: "بنك مصر - حساب الفرع الرئيسي",
  ...
  },
  {
    ...
    voucher_number: "ADJ-2026-0033",
    voucher_type: "payment",
    payment_method: "cash",
    client_type: "other",
    client_name: "تسوية عجز جرد",
    notes: "تسوية عجز بسيط مقيد بتقرير الجرد اليومي",
    balance_before: 135300,
    balance_after: 134850,
    status: "canceled",
    created_by: 1,
    user_name: "أحمد المحاسب",
    account_name: "الخزينة الرئيسية - السويس",
