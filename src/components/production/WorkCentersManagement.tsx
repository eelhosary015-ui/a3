...
const DEFAULT_CENTERS: WorkCenter[] = [
  { 
    id: '1', 
    code: 'MC-101', 
    name: 'غرفة القطع بالليزر (Laser cutting room)', 
    type: 'machine', 
    capacity: 100, 
    costPerHour: 550, 
    efficiency: 95,
    location: 'صالة تصنيع أ - قطاع الليزر',
    status: 'active',
    ...
    overheadCost: 100,
    shifts: [
      { id: 'sh-1', name: 'الوردية الصباحية (Morning Shift)', startTime: '08:00', endTime: '16:00', workersCount: 4, activeDays: ['الأحد', 'الاثنين', 'الثلاثاء', 'الأربعاء', 'الخميس'] },
      { id: 'sh-2', name: 'الوردية المسائية (Evening Shift)', startTime: '16:00', endTime: '00:00', workersCount: 3, activeDays: ['الأحد', 'الاثنين', 'الثلاثاء', 'الأربعاء', 'الخميس'] }
    ]
  },
  { 
    id: '2', 
    code: 'LN-001', 
    name: 'خط التجميع الرئيسي (Main Assembly line)', 
    type: 'line', 
    capacity: 50, 
    costPerHour: 2200, 
    efficiency: 85,
    location: 'صالة المونتاج ب - المسار النهائي',
    status: 'active',
    ...
    overheadCost: 400,
    shifts: [
      { id: 'sh-3', name: 'الوردية الأولى', startTime: '08:00', endTime: '16:00', workersCount: 15, activeDays: ['الأحد', 'الاثنين', 'الثلاثاء', 'الأربعاء', 'الخميس'] },
      { id: 'sh-4', name: 'الوردية الثانية', startTime: '16:00', endTime: '00:00', workersCount: 12, activeDays: ['الأحد', 'الاثنين', 'الثلاثاء', 'الأربعاء', 'الخميس'] },
      { id: 'sh-5', name: 'الوردية الثالثة (ليلاً)', startTime: '00:00', endTime: '08:00', workersCount: 8, activeDays: ['الأحد', 'الاثنين', 'الثلاثاء', 'الأربعاء', 'الخميس'] }
    ]
  },
  { 
    id: '3', 
    code: 'LB-050', 
    name: 'ورشة الدهان والتشطيب اليدوي', 
    type: 'labor', 
    capacity: 15, 
    costPerHour: 350, 
    efficiency: 90,
    location: 'جناح التشطيب د',
    status: 'idle',
    supervisor: 'الأستاذ حسن المعمري',
    dailyHours: 8,
    laborCost: 250,
    machineCost: 50,
    overheadCost: 50,
    shifts: [
      { id: 'sh-6', name: 'الوردية الصباحية للتشطيب', startTime: '09:00', endTime: '17:00', workersCount: 6, activeDays: ['الأحد', 'الاثنين', 'الثلاثاء', 'الأربعاء', 'الخميس', 'السبت'] }
    ]
  }
];
...
export function WorkCentersManagement() {
  const [centers, setCenters] = useState<WorkCenter[]>(() => {
    ...
    if (saved) {
      try { return JSON.parse(saved); } catch (e) { console.error('Failed to parse from local storage'); }
    }
