...
const INITIAL_TEAMS = [
  { id: 'TEAM-1', name: 'فريق فحص معمل الواردات', leader: 'م. يوسف القاضي', inspectors: ['م. يوسف القاضي', 'أ. حسن جلال'], department: 'المستودعات والمخازن' },
  { id: 'TEAM-2', name: 'فريق جودة صالات التجميع واللحام', leader: 'م. أحمد الشربيني', inspectors: ['م. أحمد الشربيني', 'م. محمود سليم'], department: 'الورش الإنتاجية' },
  { id: 'TEAM-3', name: 'لجنة الاعتماد والفرز النهائي FQC', leader: 'د. صفوان خليل', inspectors: ['د. صفوان خليل', 'م. فادي عاطف'], department: 'قسم الجودة الكلية' }
];

const INITIAL_QCP = [
  {
    id: 'QCP-001',
    title: 'قياس السمك والمقاومة السيزمية للصلب',
    productId: 'all_raw',
    productName: 'المواد المعدنية الخام',
    operationType: 'incoming', // incoming, manufacturing, delivery
    testType: 'measure', // measure, pass_fail, instructions
    targetValue: 3.0,
    toleranceMin: 2.9,
    toleranceMax: 3.1,
    unit: 'مم',
    teamId: 'TEAM-1',
    instructions: 'معايرة ميكرومترية للسمك في 5 نقاط مختلفة من اللوح المصنع والتأكد من مطابقة المواصفة ISO 9001.'
  },
  {
    id: 'QCP-002',
    title: 'اختبار صلابة وضغط اللحامات للهيكل الطولي',
    productId: 'all_semi',
    productName: 'الهياكل الخارجية',
    ...
    unit: '',
    teamId: 'TEAM-2',
    instructions: 'مراقبة لحام الذراع الآلي والتحقق من عدم وجود فقاعات هواء داخل درزة اللحام الرئيسية بخلية ت-٥.'
  },
  {
    id: 'QCP-003',
    title: 'الفحص المظهري ومطابقة التغليف للصنف التام',
    productId: 'all_finished',
    productName: 'جميع المنتجات التامة الصنع',
    ...
    unit: '',
    teamId: 'TEAM-3',
    instructions: 'التيقن من الملصقات الفنية لدرجة الأمان ومطابقة شكل صندوق الشحن وخلوه من الخدوش.'
  }
];
...
const INITIAL_CHECKS = [
  {
    id: 'QC-1001',
    qcpId: 'QCP-001',
    qcpTitle: 'قياس السمك والمقاومة السيزمية للصلب',
    orderNumber: 'PRD-2026-001',
    productName: 'ألواح حديد صلب مجلفن',
    testType: 'measure',
    measuredValue: 3.02,
    targetValue: 3.0,
    toleranceMin: 2.9,
    ...
    notes: 'القياسات جاءت متسقة للغاية بنسبة تفاوت ضئيلة.'
  },
  {
    id: 'QC-1002',
    qcpId: 'QCP-002',
    qcpTitle: 'اختبار صلابة وضغط اللحامات للهيكل الطولي',
    orderNumber: 'PRD-2026-002',
    productName: 'إطار تثبيت خارجي معدني',
    testType: 'pass_fail',
    measuredValue: 0,
    targetValue: 0,
    toleranceMin: 0,
    ...
    unit: '',
    status: 'rejected',
    inspector: 'م. محمود سليم',
    lotNumber: 'LOT-2606B',
    checkedDate: '2026-06-15',
    notes: 'تم العثور على تشققات دقيقة واهتزاز في مرونة الشحنة أثناء تبريد نقاط اللحام.'
  }
];
...
const INITIAL_ALERTS = [
  {
    id: 'QA-501',
    title: 'اهتزاز معايير سمك الإغلاق المعدني بالخلية LN-001',
    checkId: 'QC-1002',
    referenceCode: 'PRD-2026-002',
    severity: 'high', // low, medium, high
    rootCause: 'machine', // machine, material, human, method
    disposition: 'rework', // rework, scrap, vendor_return, as_is
    status: 'investigating', // new, investigating, corrective_action, resolved
    assignedTo: 'م. أحمد الشربيني',
    description: 'انفصال متكرر لنقاط اللحام في الأطراف الجانبية نتيجة هبوط الضغط الهيدروليكي الآلي بالماكينة.',
    capaAction: 'تعديل المعايرة السيزمية لذراع اللحام الآلي ت-٥ وجدولة صيانة وقائية طارئة للمنظومة الهيدروليكية.',
    loggedDate: '2026-06-15'
  },
  {
    id: 'QA-502',
    title: 'تلف أطراف ربل حماية الأواني (مطاط المستورد)',
    checkId: 'manual',
    referenceCode: 'RI-102',
    severity: 'medium',
    rootCause: 'material',
    disposition: 'vendor_return',
    status: 'corrective_action',
    assignedTo: 'م. يوسف القاضي',
    description: 'تشققات حرارية ومطاطية واضحة في كواشف العينات المستلمة تؤدي لتسرب الرطوبة والحرارة.',
    capaAction: 'حظر خط الوارد بالكامل وإشعار مسؤول مشتريات الفرع لتوجيه مطالبة ائتمانية للمورد وطلب شهادة الضمان والمنشأ.',
...
export function QualityControlManagement() {
  ...
  const [qcps, setQcps] = useState<any[]>(() => {
    ...
    return saved ? JSON.parse(saved) : INITIAL_QCP;
  });
