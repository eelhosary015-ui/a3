...
const MOCK_TASKS: MaintenanceTask[] = [
  { id: 'MT-001', workCenterId: 'MC-101', workCenterName: 'غرفة القطع بالليزر', type: 'preventive', description: 'تغيير عدسات الليزر وفلتر التبريد', scheduledDate: '2026-06-15', status: 'pending' },
  { id: 'MT-002', workCenterId: 'LN-001', workCenterName: 'خط التجميع الرئيسي', type: 'breakdown', description: 'عطل في سير الحركة رقم 2', scheduledDate: '2026-06-11', status: 'in_progress' },
];
