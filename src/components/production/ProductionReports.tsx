...
const FALLBACK_PRODUCTS: ProductReportData[] = [
  { code: 'RAW-001', name: 'حديد تسليح مقاوم للصدأ', category: 'المعادن', type: 'خام', unit: 'كجم', brand: 'حديد عز الاستراتيجي', currentStock: 150, plmStatus: 'approved', version: 'V1.0', minQty: 10, maxQty: 500, unitCost: 45 },
  { code: 'RAW-002', name: 'سيليكا نقية بلورية', category: 'المعادن', type: 'خام', unit: 'كجم', brand: 'المحاجر الوطنية', currentStock: 240, plmStatus: 'development', version: 'V1.0', minQty: 50, maxQty: 500, unitCost: 18 },
  { code: 'FIN-001', name: 'دهان جوتن مقاوم للصدأ', category: 'المنتجات النهائية', type: 'نهائي', unit: 'لتر', brand: 'جوتن العالمية', currentStock: 10, plmStatus: 'approved', version: 'V1.0', minQty: 5, maxQty: 40, unitCost: 120 },
  { code: 'RAW-003', name: 'سلك نحاس نقي معزول', category: 'المعادن', type: 'خام', unit: 'كجم', brand: 'السويدي للكابلات', currentStock: 100, plmStatus: 'approved', version: 'V1.0', minQty: 10, maxQty: 500, unitCost: 85 },
  { code: 'COMP-001', name: 'ترس هيدروليكي صناعي', category: 'الدرجات / المكونات', type: 'نصف مصنع', unit: 'قطعة', brand: 'الشركة الصناعية الهندسية', currentStock: 20, plmStatus: 'development', version: 'V1.0', minQty: 5, maxQty: 100, unitCost: 250 },
  { code: 'PACK-001', name: 'صندوق كرتون وحزم هيدروليك', category: 'مواد تعبئة', type: 'تعبئة', unit: 'قطعة', brand: 'مصر للكرتون', currentStock: 50, plmStatus: 'under_design', version: 'V1.0', minQty: 20, maxQty: 1000, unitCost: 12 }
];

const FALLBACK_ORDERS: OrderReportData[] = [
  { orderNumber: 'PRD-2026-001', productName: 'سيارة سيدان تصنيع مخصص', productId: 'FIN-500', quantity: 15, startDate: '2026-06-15', endDate: '2026-06-20', priority: 'high', status: 'in_progress', supervisor: 'م. أحمد الشافعي', progress: 45, totalCost: 150000 },
  { orderNumber: 'PRD-2026-002', productName: 'ترس هيدروليكي صناعي', productId: 'COMP-001', quantity: 150, startDate: '2026-06-10', endDate: '2026-06-13', priority: 'normal', status: 'completed', supervisor: 'أ. جلال محمود', progress: 100, totalCost: 37500 },
  { orderNumber: 'PRD-2026-003', productName: 'دهان جوتن مقاوم للصدأ', productId: 'FIN-001', quantity: 80, startDate: '2026-06-18', endDate: '2026-06-25', priority: 'high', status: 'pending', supervisor: 'م. أحمد الشافعي', progress: 0, totalCost: 9600 },
  { orderNumber: 'PRD-2026-004', productName: 'حديد تسليح مقاوم للصدأ', productId: 'RAW-001', quantity: 45, startDate: '2026-06-01', endDate: '2026-06-05', priority: 'low', status: 'completed', supervisor: 'فني طارق علي', progress: 100, totalCost: 2025 },
  { orderNumber: 'PRD-2026-005', productName: 'سلك نحاس نقي معزول', productId: 'RAW-003', quantity: 200, startDate: '2026-06-12', endDate: '2026-06-17', priority: 'normal', status: 'paused', supervisor: 'م. سامح حسن', progress: 30, totalCost: 17000 }
];

const FALLBACK_QUALITY_CHECKS: QualityCheckReportData[] = [
  { id: 'QC-7821', qcpTitle: 'فحص جودة فوري - معالجة تحضيرية أولية', orderNumber: 'PRD-2026-002', productName: 'ترس هيدروليكي صناعي', status: 'accepted', inspector: 'فني ممتاز طارق علي', checkedDate: '2026-06-11', testType: 'measure', measuredValue: 12.4, notes: 'الأبعاد والقياسات بالمليمتر مطابقة للمواصفات الفنية المعتمدة بمخطط CAD.' },
  { id: 'QC-1092', qcpTitle: 'فحص جودة دوري - فحص مظهر طلاء السطح', orderNumber: 'PRD-2026-004', productName: 'حديد تسليح مقاوم للصدأ', status: 'accepted', inspector: 'مراقب جودة الصالة فادي', checkedDate: '2026-06-04', testType: 'pass_fail', measuredValue: 1, notes: 'السطح أملس، وخالي تماماً من الفراغات والفقاعات الهوائية.' },
  { id: 'QC-5093', qcpTitle: 'فحص ضغط عيني - سلك نحاس معزول الوردية أ', orderNumber: 'PRD-2026-005', productName: 'سلك نحاس نقي معزول', status: 'rejected', inspector: 'م. سامح حسن', checkedDate: '2026-06-13', testType: 'pass_fail', measuredValue: 0, notes: 'تم رصد تشقق طفيف بالطبقة البلاستيكية المعزولة الخارجية، تم وقف الوردية.' },
  { id: 'QC-4012', qcpTitle: 'تحليل عينات ليزرية - قياس فجوة الغلاف', orderNumber: 'PRD-2026-001', productName: 'سيارة سيدان تصنيع مخصص', status: 'accepted', inspector: 'م. أحمد الشافعي', checkedDate: '2026-06-16', testType: 'measure', measuredValue: 3.12, notes: 'معدل الانحراف يقع بوضوح ضمن النطاق المقبول للملف الهندسي.' }
];

const FALLBACK_TRANSFERS: TransferredReportData[] = [
  { transferId: 'TRF-9091', orderNumber: 'PRD-2026-002', productName: 'ترس هيدروليكي صناعي', productId: 'COMP-001', quantityTransferred: 150, unit: 'قطعة', transferredBy: 'أ. جلال محمود', transferDate: '2026-06-13', targetWarehouse: 'مستودع المكونات الرئيسي - صالة أ', batchNumber: 'BAT-20260613-71', status: 'approved' },
  { transferId: 'TRF-8890', orderNumber: 'PRD-2026-004', productName: 'حديد تسليح مقاوم للصدأ', productId: 'RAW-001', quantityTransferred: 45, unit: 'كجم', transferredBy: 'فني طارق علي', transferDate: '2026-06-05', targetWarehouse: 'المخزن العام للمواد الثقيلة', batchNumber: 'BAT-20260605-12', status: 'approved' },
  { transferId: 'TRF-4011', orderNumber: 'PRD-2026-002', productName: 'حديد تسليح مقاوم للصدأ (هدر تشغيلي مرحل)', productId: 'RAW-001', quantityTransferred: 5, unit: 'كجم', transferredBy: 'مراقب الصالة محمد', transferDate: '2026-06-12', targetWarehouse: 'مخزن مخلفات وخامات الخردة والتشكيل', batchNumber: 'BATCH-WASTE-2026', status: 'transferred' },
  { transferId: 'TRF-3102', orderNumber: 'PRD-2026-005', productName: 'النحاس المعاد تصنيعه', productId: 'RAW-003', quantityTransferred: 25, unit: 'كجم', transferredBy: 'أمين الوردية أ', transferDate: '2026-06-17', targetWarehouse: 'مستودع الخامات الوسيطة ب', batchNumber: 'BAT-20260617-09', status: 'pending_receipt' }
];

const FALLBACK_EFFICIENCY: EfficiencyReportData[] = [
  { line: 'خط الإنتاج الرئيسي (أ)', target: 1000, actual: 950, oee: 92, availability: 95, performance: 98, quality: 99, downtimeHrs: 1.2, supervisor: 'م. أحمد الشافعي' },
  { line: 'خط التشكيل الهيدروليكي (ب)', target: 500, actual: 420, oee: 81, availability: 88, performance: 90, quality: 96, downtimeHrs: 2.5, supervisor: 'فني طارق علي' },
  { line: 'خط التجميع والفرز (ج)', target: 800, actual: 780, oee: 89, availability: 94, performance: 95, quality: 98, downtimeHrs: 1.0, supervisor: 'م. سامح حسن' },
  { line: 'خط الطلاء والرش الفرعي (د)', target: 300, actual: 290, oee: 94, availability: 97, performance: 98, quality: 99, downtimeHrs: 0.5, supervisor: 'أ. جلال محمود' }
];

const FALLBACK_MAINTENANCE: MaintenanceReportData[] = [
  { code: 'MC-101', name: 'كباس هيدروليكي 500 طن', type: 'وقائية', task: 'تغيير زيت الهيدروليك والفلاتر', tech: 'م. خالد عبد الرحمن', date: '2026-06-10', cost: 1200, status: 'completed' },
  { code: 'MC-102', name: 'فرن معالجة حرارية متطور', type: 'طارئة', task: 'اصلاح حساس الحرارة والترموستات', tech: 'فني مصطفى كمال', date: '2026-06-14', cost: 850, status: 'completed' },
  { code: 'MC-103', name: 'ماكينة تقطيع ليزر CNC', type: 'دورية', task: 'معايرة رأس الليزر وعدسات الضبط', tech: 'م. أسامة نبيل', date: '2026-06-18', cost: 2300, status: 'in_progress' },
  { code: 'MC-104', name: 'خط سير ناقل أوتوماتيكي', type: 'وقائية', task: 'تشحيم المحامل وضبط التوتر', tech: 'فني علي حسين', date: '2026-06-20', cost: 450, status: 'scheduled' }
];

const FALLBACK_BOM_WASTE: BomWasteReportData[] = [
  { bomCode: 'BOM-RAW-001', productName: 'حديد تسليح مقاوم للصدأ', standardQty: 100, actualUsed: 104, scrapQty: 4, unit: 'كجم', variancePct: 4.0, wasteCost: 320, status: 'within_limit' },
  { bomCode: 'BOM-COMP-001', productName: 'ترس هيدروليكي صناعي', standardQty: 50, actualUsed: 53, scrapQty: 3, unit: 'قطعة', variancePct: 6.0, wasteCost: 750, status: 'exceeded' },
  { bomCode: 'BOM-FIN-001', productName: 'دهان جوتن مقاوم للصدأ', standardQty: 200, actualUsed: 201, scrapQty: 1, unit: 'لتر', variancePct: 0.5, wasteCost: 90, status: 'optimal' },
  { bomCode: 'BOM-RAW-003', productName: 'سلك نحاس نقي معزول', standardQty: 150, actualUsed: 158, scrapQty: 8, unit: 'كجم', variancePct: 5.3, wasteCost: 1120, status: 'exceeded' }
];
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-5 no-print">
            ...
            <div className="p-3.5 bg-emerald-50/50 rounded-2xl border border-emerald-100">
              ...
              <strong className="text-lg font-black text-emerald-900 font-mono mt-0.5 block">
                {filteredProducts.reduce((sum, p) => sum + p.currentStock, 0)} وحدة
              </strong>
            </div>
        ...
        {activeSubTab === 'transferred' && (
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-5 no-print">
            ...
            <div className="p-3.5 bg-indigo-50/50 rounded-2xl border border-indigo-100">
              ...
              <strong className="text-lg font-black text-indigo-900 font-mono mt-0.5 block">
                {filteredTransfers.reduce((sum, t) => sum + t.quantityTransferred, 0)} وحدة
              </strong>
            </div>
            <div className="p-3.5 bg-amber-50 rounded-2xl border border-amber-100">
        ...
        {activeSubTab === 'efficiency' && (
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-5 no-print">
            ...
            <div className="p-3.5 bg-emerald-50/50 rounded-2xl border border-emerald-100">
              ...
              <strong className="text-lg font-black text-emerald-900 font-mono mt-0.5 block">
                {Math.round(filteredEfficiency.reduce((sum, e) => sum + e.oee, 0) / (filteredEfficiency.length || 1))}%
              </strong>
            </div>
            <div className="p-3.5 bg-indigo-50/50 rounded-2xl border border-indigo-100">
              <span className="text-[10px] font-black text-indigo-400 block uppercase">نسبة الجاهزية التشغيلية</span>
              <strong className="text-lg font-black text-indigo-900 font-mono mt-0.5 block">
                {Math.round(filteredEfficiency.reduce((sum, e) => sum + e.availability, 0) / (filteredEfficiency.length || 1))}%
              </strong>
            </div>
            <div className="p-3.5 bg-amber-50 rounded-2xl border border-amber-100">
              <span className="text-[10px] font-black text-amber-500 block uppercase">إجمالي ساعات التوقف</span>
              <strong className="text-lg font-black text-amber-900 font-mono mt-0.5 block">
                {filteredEfficiency.reduce((sum, e) => sum + e.downtimeHrs, 0)} ساعة
              </strong>
            </div>
          </div>
        )}
